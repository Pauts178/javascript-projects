...
} else (typeof str === 'number') 
{
 let newStr = str.toString();
 return parseInt(newStr.split('').reverse().join(''));
}
}
console.log(reverseDigits(str1))
...
for (let i = 0; i < inputArray.length; i++){
    newArray.push(reverseDigits(inputArray[i])); 
}
...
function areaOfShape(length, width = length) {
